...
function normalizeSettings(value: unknown): StoreSettings {
  ...
  return {
    ...
    featuredEnabled: source.featuredEnabled ?? true,
    trendingEnabled: source.trendingEnabled ?? true,
    heroSecondaryCta: source.heroSecondaryCta || "rgb",
    supportEmail: source.supportEmail || "",
    footerDescriptionEn: source.footerDescriptionEn || "Badzy Store — Egypt's premier gaming accessories and setup gear provider. Dark aesthetics, tuned for speed.",
    footerDescriptionAr: source.footerDescriptionAr || "متجر بادزي ستور — وجهتك الأولى لمعدات القيمنق والإضاءة في مصر. جودة عالية وتوصيل سريع لكل المحافظات.",
    footerCopyrightEn: source.footerCopyrightEn || "© {year} Badzy Store Egypt. All rights reserved.",
    footerCopyrightAr: source.footerCopyrightAr || "© {year} بادزي ستور مصر. جميع الحقوق محفوظة.",
    footerTaglineEn: source.footerTaglineEn || "Built for real Egyptian gamers.",
    footerTaglineAr: source.footerTaglineAr || "مصمم للاعبين المصريين.",
    statsDeliverySpeedEn: source.statsDeliverySpeedEn || "24h",
    statsDeliverySpeedAr: source.statsDeliverySpeedAr || "24h",
    statsDeliverySpeedLabelEn: source.statsDeliverySpeedLabelEn || "Fastest delivery",
    statsDeliverySpeedLabelAr: source.statsDeliverySpeedLabelAr || "توصيل أسرع",
    statsDeliveryScopeEn: source.statsDeliveryScopeEn || "Egypt",
    statsDeliveryScopeAr: source.statsDeliveryScopeAr || "مصر",
    statsDeliveryScopeLabelEn: source.statsDeliveryScopeLabelEn || "Nationwide",
    statsDeliveryScopeLabelAr: source.statsDeliveryScopeLabelAr || "توصيل لكل محافظة",
    deliveryEstimateTitleEn: source.deliveryEstimateTitleEn || "Estimated Delivery Times",
    deliveryEstimateTitleAr: source.deliveryEstimateTitleAr || "مواعيد التوصيل المتوقعة",
    deliveryCairoAlexEn: source.deliveryCairoAlexEn || "Alexandria & Cairo: 1–2 Business Days",
    deliveryCairoAlexAr: source.deliveryCairoAlexAr || "الإسكندرية والقاهرة: 1–2 يوم عمل",
    deliveryRestEgyptEn: source.deliveryRestEgyptEn || "Rest of Egypt: 3–5 Business Days",
    deliveryRestEgyptAr: source.deliveryRestEgyptAr || "باقي محافظات مصر: 3–5 أيام عمل",
    reviewsPlaceholderEn: source.reviewsPlaceholderEn || "Rated 4.8 / 5 stars based on customer feedback across Egypt.",
    reviewsPlaceholderAr: source.reviewsPlaceholderAr || "تقييم 4.8 / 5 نجوم بناءً على آراء العملاء في مصر.",
    storeLocationEn: source.storeLocationEn || "Alexandria & Cairo, Egypt",
    storeLocationAr: source.storeLocationAr || "الإسكندرية والقاهرة، مصر",
    seoDescriptionEn: source.seoDescriptionEn || "Shop mice, mechanical keyboards, RGB accessories and streaming gear at Badzy Store. Fast delivery across Egypt.",
    seoDescriptionAr: source.seoDescriptionAr || "تسوق الفئران، لوحات المفاتيح الميكانيكية، إكسسوارات RGB ومعدات البث في متجر بادزي. توصيل سريع في جميع أنحاء مصر.",
    seoKeywords: source.seoKeywords || "gaming gear, mice, keyboards, RGB, streaming, Badzy Store, Egypt gaming",
    storeNameEn: source.storeNameEn || "Badzy Store",
    storeNameAr: source.storeNameAr || "بادزي ستور",
