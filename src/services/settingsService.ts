...
export function normalizeStoreSettings(value: unknown): StoreSettings {
  ...
  return {
    ...
    featuredEnabled: source.featuredEnabled ?? DEFAULT_STORE_SETTINGS.featuredEnabled,
    trendingEnabled: source.trendingEnabled ?? DEFAULT_STORE_SETTINGS.trendingEnabled,
